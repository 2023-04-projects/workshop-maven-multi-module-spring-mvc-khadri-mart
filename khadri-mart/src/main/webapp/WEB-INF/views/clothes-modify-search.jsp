...
<body>
    ...
    <form:form method="post" modelAttribute="searchForm" action="${pageContext.request.contextPath}/clothes/search">
        <table>
            <tr>
                <td>Clothes Name:</td>
    ...
    <%
    List<ClothesForm> listOfSearchItemForms = (List<ClothesForm>) request.getAttribute("listOfSearchItemForms");
    ...
    <table border="1">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <a href="${pageContext.request.contextPath}/clothes/modify?clothesName=<%= eachForm.getItemName() %>&clothesQty=<%= eachForm.getItemQty() %>&clothesPrice=<%= eachForm.getItemPrice() %>">
